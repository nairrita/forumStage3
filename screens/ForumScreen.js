      ...
      <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
        <ScrollView style={styles.scrollView}>
          ...
          >
            ...
            <Image source={logo} style={styles.shareYourProblemImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo2} style={styles.drivingLicenseImage} />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button1}
            onPress={() => {
          ...
          >
            ...
            <Image source={logo4} style={styles.aadharCardImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo3} style={styles.panCardImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo5} style={styles.passportImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo7} style={styles.automobilesImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo8} style={styles.travelImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo9} style={styles.filmImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo10} style={styles.sportsImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo11} style={styles.eImage} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Image source={logo12} style={styles.foodImage} />
          </TouchableOpacity>
